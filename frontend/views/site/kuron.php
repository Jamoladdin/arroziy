<?php
$this->title = 'Қуръон Ва Тажвид';
$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Қуръон Ва Тажвид, Quron Va Tajvid'
]);

$this->registerMetaTag([
    'name' => 'keywords',
    'content' => 'Arroziy.uz, Қуръон Ва Тажвид, Quron Va Tajvid'
]);
?>
<!-- Banner Area Start -->
...
<div class="blog-area event-area three text-center pt-90 pb-60">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    <h1 class="page-title">Қуръон Ва Тажвид</h1>
                    ...
                    <div class="myitem mb-100">
                        ...
                        <img src="/backend/web/321/qn10/<?= $item->img?>" alt="Аррозий ўрта махсус билим юрти" class="myitem-img">
                        <p class="myitem-text mt-10"><?= $item->text?></p>
                        <a href="/kuronid/<?= $item->id?>" class="btn btn-danger myitem-btn mt-10 mb-10 pull-right clear">Тўлиқ ўқиш</a>
                    </div>
                    <hr>
                    <?endforeach;?>
                </div>
