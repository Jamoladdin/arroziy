...
$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Хабарлар, Xabarlar'
]);

$this->registerMetaTag([
    'name' => 'keywords',
    'content' => 'Arroziy.uz, Хабарлар, Xabarlar'
]);
?>
<!-- Banner Area Start -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="single-event mb-60">
                            <div class="event-img">
                                <a href="/newsid/<?= $item->id?>">
                                    <img src="/backend/web/321/x10/<?= $item->img?>" alt="Аррозий ўрта махсус билим юрти">
                            ...
                            <div class="event-content text-left">
                                <h4><a href="/newsid/<?= $item->id?>"><?= $item->title?></a></h4>
                                <ul>
                                    <li><span>Сана:</span> <?= $item->date?></li>
                                </ul>
                                <div class="event-content-right">
                                    <a class="default-btn" href="/newsid/<?= $item->id?>">Кўпроқ</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                <div class="blog-sidebar right text-left">
                    <div class="single-blog-widget mb-50">
                        <h3>янги маколалар</h3>
                        <div class="single-blog-banner mb-30">
                            <div class="single-blog-banner">
                                <a href="/maqolaid/<?= $model2[0]->id?>"><img src="/backend/web/321/mq10/<?=$model2[0]->img?>" style="width: 306px; height: 313px; object-fit: cover;" alt="Аррозий ўрта махсус билим юрти"></a>
                        ...
                        <?php for($i=1; $i<7; $i++){ if(!isset($model2[$i])) break ?>
                            <div class="single-post mb-30">
                                <div class="single-post-img">
                                    <a href="/maqolaid/<?= $model2[$i]->id?>"><img src="/backend/web/321/mq10/<?=$model2[$i]->img?>" alt="Аррозий ўрта махсус билим юрти">
                                ...
                                <div class="single-post-content">
                                    <h4><a href="/maqolaid/<?= $model2[$i]->id?>"><?= mb_substr($model2[$i]->title, 0, 24).'...'?></a></h4>
