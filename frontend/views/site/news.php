                        ...
                        <div class="single-event mb-60">
                            <div class="event-img">
                                <a href="/newsid/<?= $item->id?>">
                                    <img src="/backend/web/321/x10/<?= $item->img?>" alt="">
                    ...
                    <div class="single-blog-widget mb-50">
                        ...
                        <div class="single-blog-banner mb-30">
                            <div class="single-blog-banner">
                                <a href="/maqolaid/<?= $model2[0]->id?>"><img src="/backend/web/321/mq10/<?=$model2[0]->img?>" style="width: 306px; height: 313px; object-fit: cover;" alt=""></a>
                        ...
                        <?php for($i=1; $i<7; $i++){ if(!isset($model2[$i])) break ?>
                            <div class="single-post mb-30">
                                <div class="single-post-img">
                                    <a href="/maqolaid/<?= $model2[$i]->id?>"><img src="/backend/web/321/mq10/<?=$model2[$i]->img?>" alt="">
