                ...
                <div class="row">
                    ...
                    <?foreach ($model as $item):?>
                        <div class="myitem mb-100">
                            ...
                            <img src="/backend/web/321/aq10/<?= $item->img?>" alt="Аррозий ўрта махсус билим юрти" class="myitem-img">
                            <p class="myitem-text mt-10"><?= $item->text?></p>
                            <a href="/aqidaid/<?= $item->id?>" class="btn btn-danger myitem-btn mt-10 mb-10 pull-right clear">Тўлиқ ўқиш</a>
                        </div>
                        <hr>
                    <?endforeach;?>
                </div>
