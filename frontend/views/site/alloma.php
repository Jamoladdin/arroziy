...
<div class="blog-area event-area three text-center pt-90 pb-60">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    <h1 class="page-title">Юртимиз алломалари</h1>
                    <?foreach ($model as $item):?>
                        <div class="myitem mb-100">
                            ...
                            <img src="/backend/web/321/al10/<?= $item->img?>" alt="" class="myitem-img">
                            <p class="myitem-text mt-10"><?= $item->text?></p>
                            <a href="/allomaid/<?= $item->id?>" class="btn btn-danger myitem-btn mt-10 mb-10 pull-right clear">Тўлиқ ўқиш</a>
                        </div>
                        <hr>
                    <?endforeach;?>
                </div>
