<?php
$this->title = 'АХБОРОТ — РЕСУРСЛАРИ МАРКАЗИ';
$this->registerMetaTag([
    'name' => 'description',
    'content' => 'АХБОРОТ — РЕСУРСЛАРИ МАРКАЗИ, AXBOROT - RESURS MARKAZI'
]);

$this->registerMetaTag([
    'name' => 'keywords',
    'content' => 'Arroziy.uz, ҚАХБОРОТ — РЕСУРСЛАРИ МАРКАЗИ, AXBOROT - RESURS MARKAZI'
]);
?>
<!-- Banner Area Start -->
                ...
                <div class="col-xs-12">
                    <div class="banner-content-wrapper">
                        <div class="banner-content">
                            <h2>АХБОРОТ — РЕСУРСЛАРИ МАРКАЗИ</h2>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="blog-area event-area three text-center pt-90 pb-60">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    <h1 class="page-title mb-30">АХБОРОТ — РЕСУРСЛАРИ МАРКАЗИ</h1>
                        ...
                        <?php for($i=1; $i<7; $i++){ if(!isset($model2[$i])) break ?>
                            <div class="single-post mb-30">
                                ...
                                <div class="single-post-content">
                                    <h4><a href="/newsid/<?= $model2[$i]->id?>"><?= mb_substr($model2[$i]->title, 0, 24).'...'?></a></h4>
