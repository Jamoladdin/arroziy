<?php
$this->title = 'Талабалар турар жойи';
$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Талабалар турар жойи, Talabalar turar joyi'
]);

$this->registerMetaTag([
    'name' => 'keywords',
    'content' => 'Arroziy.uz, Талабалар турар жойи, Talabalar turar joyi'
]);
?>
<!-- Banner Area Start -->
...
<div class="blog-area event-area three text-center pt-90 pb-60">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    <h1 class="page-title mb-30">ТАЛАБАЛАР ТУРАР ЖОЙИ</h1>
