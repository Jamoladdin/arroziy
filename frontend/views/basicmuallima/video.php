...
$this->registerMetaTag([
    'name' => 'description',
    'content' => "Arroziy nomidagi o'tra maxsus islom bilim yurti video fayllari"
]);

$this->registerMetaTag([
    'name' => 'keywords',
    'content' => "arroziy, o'tra, maxsus, islom, bilim, yurti, video, video fayllar, o'zbekiston, xorazm, urganch, uz"
]);
...
$this->registerMetaTag([
    'property' => 'og:url',
    'content' => 'http://arroziy.uz/media/video'
]);
                ...
                <div class="row">
                    <div class="media">
                        ...
                        <div class="video-item">
                            <a href="<?= $item->name?>" class="video-popup">
                                <h2><?= $item->title?></h2>
                            </a>
