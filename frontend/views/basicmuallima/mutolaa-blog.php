...
$this->registerMetaTag([
    'name' => 'description',
    'content' => "Arroziy nomidagi o'tra maxsus islom bilim yurti xabarlari, yangiliklari, maqolalari hamda tavsiyalari"
]);

$this->registerMetaTag([
    'name' => 'keywords',
    'content' => "arroziy, o'tra, maxsus, islom, bilim, yurti, xabarlar, maqolalar, tavsiya, o'zbekiston, xorazm, urganch, uz"
]);
...
$this->registerMetaTag([
    'property' => 'og:url',
    'content' => 'http://arroziy/mutolaa/'.$cilm->slug
]);
$this->registerMetaTag([
                    ...
                    <?foreach ($model as $item): ?>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="single-blog mb-60">
                                <div class="blog-img">
                                    <a href="/mutolaa/<?= $cilm->slug.'/'.$item->year.'/'.$item->month.'/'.$item->day.'/'.$item->slug?>">
                                ...
                                <div class="blog-content">
                                    ...
                                    <div class="blog-bottom">
                                        <h2><a href="/mutolaa/<?= $cilm->slug.'/'.$item->year.'/'.$item->month.'/'.$item->day.'/'.$item->slug?>"><?= $item->title?></a></h2>
                                        <a href="/mutolaa/<?= $cilm->slug.'/'.$item->year.'/'.$item->month.'/'.$item->day.'/'.$item->slug?>">БАТАФСИЛ</a>
                                    </div>
                                </div>
                            </div>
                        </div>
